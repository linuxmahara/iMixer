    ...
    <div class="row py-lg-1">
      <div class="col-lg-6 col-md-8 mx-auto">
        ...
        <p>
          ...
          <a href="https://yogos.com/imixer/mygallery" id="login-text" class="btn btn-secondary my-2">Test</a>
        </p>
      </div>
    </div>
  </section>
        ...
        <div class="col" id = "elem0">
          <div class="card shadow-sm" style="background-color: #2c2e37">
            ...
            <div class="card-body">
              ...
              <p class="card-text" id = "cardText2" style="color:gray"></p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-secondary" id = "galBtn1" >👍</button>
                  <button type="button" class="btn btn-sm btn-outline-secondary" id = "galBtn2" >👎</button>
                  <button type="button" class="btn btn-sm btn-outline-primary" id = "galBtn2" >BUY</button>
                </div>
...
<footer class="text-muted py-5">
  <div class="container">
    ...
    // call the nft_tokens view method
	var colCounter = 1;
	
    contract.nft_tokens({"limit": 100})
      .then(messages => {
        ...
        messages.forEach(message => {
			...
			document.getElementById('cardText').textContent = message.metadata.title;
			document.getElementById('cardText2').textContent = message.owner_id;
    ...
    document.getElementById('add-text').addEventListener('click', () => {
      if (wallet.isSignedIn()) {
        ...
        wallet.requestSignIn({
          ...
          methodNames: ['nft_tokens', 'nft_mint']
        });
      }
    });
